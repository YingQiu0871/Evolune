...
import io.github.yuninggu.evolune.widget.EvoluneWidgetReceiver
import io.github.yuninggu.evolune.widget.WidgetQuickActionOutcome
import io.github.yuninggu.evolune.widget.WidgetQuickActionWork
import io.github.yuninggu.evolune.widget.WidgetUpdateWork
...
class ReceiverLifecycleInstrumentationTest {
    ...
    private companion object {
        const val ACTION_REMINDER_TEST = "io.github.yuninggu.evolune.test.REMINDER"
        const val ACTION_RESCHEDULE_TEST = "io.github.yuninggu.evolune.test.RESCHEDULE"
        const val ACTION_WIDGET_RECORD = "io.github.yuninggu.evolune.widget.RECORD_PLAN"
