...
[前往 Evolune v1.6.0 Release 下载](https://github.com/YingQiu0871/Evolune/releases/tag/v1.6.0)
...
当前 `main` 对应已发布的 **v1.6.0**。v1.6 Widget Gallery 已完成独立复审、真实 Phone/Wear 覆盖安装与项目负责人真实手表验收。
...
下一候选里程碑是 **v1.7 — Optional CPA PK Curve**；它默认关闭，并须先完成独立科学与来源审查。
