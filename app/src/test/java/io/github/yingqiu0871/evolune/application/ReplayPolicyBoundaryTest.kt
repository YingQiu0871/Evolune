...
class ReplayPolicyBoundaryTest {
    ...
    fun `typed recorders own policy selection and Wear production remains disconnected`() {
        val applicationRoot = Path.of("src/main/java/io/github/yingqiu0871/evolune/application")
        ...
        val reminder = Files.readString(
            Path.of("src/main/java/io/github/yingqiu0871/evolune/reminder/ReminderReceiverWork.kt")
        )
        val widget = Files.readString(
            Path.of("src/main/java/io/github/yingqiu0871/evolune/widget/WidgetWork.kt")
        )
        val wearProduction = Files.readString(
            Path.of("src/main/java/io/github/yingqiu0871/evolune/wear/WearDataLayer.kt")
        )
