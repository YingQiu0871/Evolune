...
class DomainDoseEventToPkBoundaryTest {
    ...
    fun `production has one formal event projection and no Batch 6 PK bridge`() {
        ...
        val hrtSource = Files.readString(
            Path.of("src/main/java/io/github/yingqiu0871/evolune/viewmodel/HRTViewModel.kt")
        )
        ...
        assertFalse(Files.exists(
            Path.of("src/main/java/io/github/yingqiu0871/evolune/application/Batch6DoseEventCompatibility.kt")
        ))
    }
    ...
    fun `formal adapter is pure structural Kotlin boundary`() {
        val source = Files.readString(
            Path.of(
                "src/main/java/io/github/yingqiu0871/evolune/core/adapter/" +
