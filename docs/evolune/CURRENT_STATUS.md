...
- `v1.7`: History & Insights program — **Phase A CLOSED**（A-04 APPROVE）；**Phase B CLOSED**
  ...
  **Phase C（Retrospective PK）— APPROVED / CLOSED**：
  ...
  - v1.7.2 Slice D（History 推断匹配文案移除）— **CLOSED / FROZEN**（implementation @
    `50b20e8cbe19b8dcc2d5d6e100a072dd61251396`；evidence
  ...
  - **v1.7.3 发布 — RELEASED**（annotated tag `v1.7.3` @
    ...
    closure packet `review-packets/v173-final-release.txt`）。
  ...
  - **v1.8.0 打包候选（版本 1.8.0 / Phone 101080000 / Wear 1101080000）— APPROVED /
    ...
    release notes `docs/evolune/v1.8.0/V180_RELEASE_NOTES.md`）。
